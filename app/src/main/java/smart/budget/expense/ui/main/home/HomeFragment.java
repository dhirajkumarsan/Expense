...
import smart.budget.expense.firebase.models.UserSettings;
import smart.budget.expense.base.BaseFragment;
import smart.budget.expense.ui.options.InterestCalculator;
import smart.budget.expense.util.CalendarHelper;
...
import smart.budget.expense.firebase.viewmodel_factories.TopWalletEntriesViewModelFactory;
import smart.budget.expense.firebase.models.User;
import smart.budget.expense.libraries.Gauge;
...
public class HomeFragment extends BaseFragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_calculator:
                startActivity(new Intent(getActivity(), InterestCalculator.class));
                return true;
            default:
    ...
    private void dataUpdated() {
        ...
        if (user.userSettings.homeCounterType == UserSettings.HOME_COUNTER_TYPE_SHOW_LIMIT) {
            ...
            gaugeRightLine1TextView.setText("Expenses/Borrowers");
            gaugeRightLine2TextView.setVisibility(View.INVISIBLE);
